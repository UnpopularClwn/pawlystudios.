...
export default function SetSailExperience() {
  ...
  function geometryFromPreview() {
    const source = previewRef.current.getBoundingClientRect()
  ...
  function openProject() {
    ...
    const geometry = geometryFromPreview()
  ...
  return (
    <div className="setsail-hero-experience" data-hero="visual">
      <div className="setsail-hero-preview" ref={previewRef}>
        <div className="setsail-hero-preview-header">
          <div>
            <p className="setsail-hero-preview-eyebrow">Featured Build</p>
            <p className="setsail-hero-preview-title">SetSail Client Portal</p>
          </div>
          <p className="setsail-hero-preview-type">Client Portal · Web App</p>
        </div>

        <div className="setsail-hero-preview-image">
          <Image
            src={primary.src}
            alt={primary.alt}
            width={primary.width}
            height={primary.height}
            sizes="(max-width: 720px) calc(100vw - 92px), (max-width: 960px) 278px, 428px"
          />
        </div>

        <button
          className="setsail-explore-trigger"
          type="button"
          ref={triggerRef}
          aria-haspopup="dialog"
          aria-controls="setsail-project-dialog"
          onClick={openProject}
        >
      ...
      <dialog
        ...
        id="setsail-project-dialog"
        ref={dialogRef}
        aria-labelledby="setsail-dialog-title"
        aria-describedby="setsail-dialog-intro"
        ...
        <article className="setsail-dialog-panel" ref={panelRef}>
          ...
          <div className="setsail-dialog-content">
            <header className="setsail-dialog-header">
              ...
              <h2 id="setsail-dialog-title">SetSail Client Portal</h2>
              <p id="setsail-dialog-intro">{details.intro}</p>
            </header>
